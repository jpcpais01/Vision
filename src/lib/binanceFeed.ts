 ...
 * unlike a polled REST endpoint. This is one exchange's own tape, not a
 * cross-exchange aggregate (CoinGecko, see `coingecko.ts`, is that — and
 * remains the fallback here when this feed has nothing fresh), but it is
 * the only way to get real second-to-second movement for free.
 *
